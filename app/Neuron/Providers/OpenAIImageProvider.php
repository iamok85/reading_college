...
class OpenAIImageProvider implements AIProviderInterface
{
    ...
    {
        throw new RuntimeException('Streaming is not supported for image generation.');
    }

    public function structured(array $messages, string $class, array $response_schema): Message
    {
        throw new RuntimeException('Structured responses are not supported for image generation.');
    }
